...
public abstract class Grantee  implements java.io.Serializable {
    public Grantee() {
    }
    ...
    static {
        typeDesc.setXmlType(new javax.xml.namespace.QName("http://s3.amazonaws.com/doc/2006-03-01/", "Grantee"));
    }
